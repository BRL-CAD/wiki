...
We suggest you [compile BRL-CAD](Compiling.md) yourself or, if
...
4.  Run "svn up brlcad-svn-trunk" and
    [compile](Compiling#Configure_your_Build.md).
...
expected to [provide a patch file](Patches.md). Make sure you
