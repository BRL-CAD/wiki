...
widgets.![](straightrebar_taskpanel.png "fig:straightrebar_taskpanel.png")
...
![](Straightrebar_image.png "fig:Straightrebar_image.png")
...
![](Straightrebar5.png "fig:Straightrebar5.png")
![](U-shaperebar.png "fig:U-shaperebar.png")
...
-   Learnt all the mathematical concepts of stirrup and derives formulas
    to find rounding length.![](Stirrup.jpg "fig:Stirrup.jpg")
...
![](stirrup1.png "fig:stirrup1.png")
![](stirrup2.png "fig:stirrup2.png")
...
-   Made an icon for dialog box of rebar distribution.
    ![](Rebardistribution.jpg "fig:Rebardistribution.jpg")
-   Added button for custom spacing in straight rebar dialog box and
    ...
    ![](Rebardistribution2.png "fig:Rebardistribution2.png")
...
![](PopimageUshapeRebar.png "PopimageUshapeRebar.png")
...
-   Wrote code in CircularStirrup.py file.
    ...
    ![](CircluarStirrup3.png "fig:CircluarStirrup3.png")
    ![](circluarStirrup4.png "fig:circluarStirrup4.png")
-   Discussed issues related to circular stirrup with Yorik which comes
    when I set `Part::Helix` as a base of rebar object.
    ![](helix.png "fig:helix.png") ![](helix2.png "fig:helix2.png")
...
-   Added description image in Bent shape rebar.
    ...
    ![](Bentshapepopup.png "fig:Bentshapepopup.png")
-   Fixed bug
...
-   Implemented `Part::Helix` in circular(helical) rebar.
    ...
    ![](Helicalrebar1.png "fig:Helicalrebar1.png")
    ![](Helicalrebar2.png "fig:Helicalrebar2.png")
