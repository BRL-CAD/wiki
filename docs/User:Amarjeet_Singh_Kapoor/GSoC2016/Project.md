...
divide the task in to there parts: ![](image05.png "fig:image05.png")
...
5.  **Resolve issues found with existing code** There are some issues
    ...
    > everything is correct. ![](image07.png "fig:image07.png")
    ...
    > ![](image06.png "fig:image06.png")
    > ![](image03.jpg "fig:image03.jpg")
    >
