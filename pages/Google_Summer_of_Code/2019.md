...
-   Implementing auto-arrange feature in Slic3r to help print as much
    ...
    is what we need.
-   Org: Slic3r
-   Student: [Mohamed Abdelhady](/wiki/user/3bhady)
...
-   This project is to automate Reinforcement process by using Rebar
    ...
    Reinforcement.
-   Org: FreeCAD
-   Student: [Suraj](/wiki/user/Suraj_Dadral)
-   [Abstract](https://summerofcode.withgoogle.com/projects/#4615685316018176)
-   [Project Plan](/wiki/user/Suraj_Dadral/gsoc_proposal)
-   [Dev Log](/wiki/user/Suraj_Dadral/GSoC19/logs)
...
-   Org: BRL-CAD
-   Student: [Quentin Paden](/wiki/user/Quentinpaden)
...
-   [Dev Log](/wiki/user/Quentinpaden)
...
-   Org: OpenSCAD
-   Student: [Romit Kumar](/wiki/user/RomitKumar)
-   [Abstract](https://summerofcode.withgoogle.com/projects/#5042363104231424)
-   [Project Plan](/wiki/user/RomitKumar/GSoC19/proposal)
-   [Dev Log](/wiki/user/RomitKumar/GSoC19/logs)
...
-   Org: OpenSCAD
-   Student: [Xuwei Tan](/wiki/user/Xuwei)
...
-   [Dev Log](/wiki/user/Xuwei/DevLog2019)
...
-   This project aims to encourage new developers to adopt FreeCAD
    ...
    environment.
-   Org: FreeCAD
-   Student: [Zachary Gummow](/wiki/user/Zachg)
...
-   [Dev Logs](/wiki/user/Sadeep/DevLog-NewGui)
...
-   [Project Plan](/wiki/user/Ali_Haydar/GSOC19/project)
