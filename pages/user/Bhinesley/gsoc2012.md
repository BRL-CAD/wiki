...
| **[Add -exec option to 'search'](Add_exec_option_to_search.md):** This involves obtaining an array of available commands, which is currently impossible (well, doing it the right way). Search isn't the only feature with a use for such a thing. | [Drafting proposal](Bhinesley/gsoc2012/search_proposal.md) |
