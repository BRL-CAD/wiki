...
-   researching how vertices are labelled in 'SOLID EDIT' mode
    ...
    -   traced: stateChange(int UNUSED(oldstate), int newstate) from
        mged/buttons.c
    -   usage of [sed] command and [facedef] command (relevant to nmg
...
-   [kill V]
    ...
    -   user then issues selected coord for [kill V]
-   [commit
